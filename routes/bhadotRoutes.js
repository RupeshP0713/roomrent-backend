...
router.get('/:id', authMiddleware, roleMiddleware(['bhadot']), bhadotController.getBhadotById);
router.put('/:id', authMiddleware, roleMiddleware(['bhadot']), bhadotController.updateBhadot);
router.put('/:id/active', authMiddleware, roleMiddleware(['bhadot']), bhadotController.toggleBhadotActive);
router.get('/:id/requests', authMiddleware, roleMiddleware(['bhadot']), bhadotController.getBhadotRequests);
